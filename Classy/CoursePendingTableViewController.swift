//
//  CoursePendingTableViewController.swift
//  Classy
//
...
class CoursePendingTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        println("in pending course view")
        println(currentCourseName)
        ...
        let notDonePredicate = NSPredicate(format: "assignmentComplete == false")
        let predicate = NSCompoundPredicate(type: NSCompoundPredicateType.AndPredicateType, subpredicates: [coursePredicate, notDonePredicate])
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("pendingAssignmentCell") as! UITableViewCell
